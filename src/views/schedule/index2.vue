        ...
        <el-card>
            <el-form :inline="true" class="demo-form-inline">
                <el-form-item label="Author">
                    <el-input v-model="selectParam.author"></el-input>
                </el-form-item>     
                ...
                <el-form-item label="新建" style="float: right">
                    <el-button type="primary" icon="el-icon-edit" @click="toSave"></el-button>
                </el-form-item>  
            </el-form>
        </el-card>
        ...
        <el-card>
            ...
            >
                ...
                <el-table-column label="Graphics" width="110" align="center">
                    <template slot-scope="scope">
                        <charts ref="grpRef" :graphics="scope.row.graphics" grpHeight="100px" :grpKey="scope.$index"/>
                     </template>
                </el-table-column>
